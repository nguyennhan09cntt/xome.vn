...
if (strtolower($hostInfo[0])=='www') {
    header('Location: http://m.xome.ln3.in', true, 301);
}
$moduleName = !in_array($hostInfo[0], array('phong-tro', 'www','xome')) ? $hostInfo[0] : 'default';
$moduleName = str_replace('-staging', '', $moduleName);
$moduleName = $moduleName=='m' ? 'mobile' : $moduleName;
if ($moduleName == 'default' && PC_MODE == 0) {
