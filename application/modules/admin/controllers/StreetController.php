...
class Admin_StreetController extends Application_Controller_BackEnd_Admin
{
    public function indexAction()
    {
        $name = $this->getRequest()->getParam('n');

        $level = $this->getRequest()->getParam('a');

        $this->loadGird(Admin_Model_Street::getInstance()->searchQuery($name, $fkComponent, $level));
